...
namespace EOToolsWeb.Api.Migrations
{
    ...
    [Migration("20241213071456_permissions2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EOToolsWeb.Shared.Permissions.PermissionsPerUserModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EOToolsWeb.Shared.Permissions.PermissionsPermissionsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PermissionsPermissionsModel");

                    b.HasAnnotation("Relational:JsonPropertyName", "updates");
                });
            ...
            modelBuilder.Entity("EOToolsWeb.Shared.Permissions.PermissionsPerUserModel", b =>
                {
                    b.HasOne("EOToolsWeb.Shared.Permissions.PermissionsPermissionsModel", "Permissions")
                        .WithMany()
                        .HasForeignKey("PermissionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EOToolsWeb.Shared.Permissions.PermissionsPermissionsModel", "Updates")
                        .WithMany()
