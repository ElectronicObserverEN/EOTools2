...
public partial class PaginationViewModel : ObservableObject
{
    ...
    {
        _currentPage = Enumerable.First<PaginationPageViewModel>(Pages);
        _lastPage = Enumerable.Last<PaginationPageViewModel>(Pages);
    }
    ...
    {
        List<PaginationPageViewModel> paginationPageViewModels = Enumerable.ToList<PaginationPageViewModel>(Pages);
